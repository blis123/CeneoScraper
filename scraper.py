...
print(type(review))
review = page_dom.select("div.js_product-review")
print(type(review))
...
pros = review.select("div.review-feature__title--positives ~ div.review-feature__item").text.strip()
cons = review.select("div.review-feature__title--negatives ~ div.review-feature__item").text.strip()
...
purchase_date = review.select_one("span.user-post__published > time:nth-child(2)["datetime"]").text.strip()